...
- 桌面集成能力当前通过 Flutter 桌面插件实现，入口逻辑在 `lib/services/desktop_integration.dart`、`lib/desktop/floating_ball_app.dart`。
- 当前桌面交互已切换为真正多窗口，而不是在主界面里伪装半个悬浮球。
